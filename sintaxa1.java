...
public class sintaxa1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sintaxa1);
        ...
        TextView m1=(TextView) findViewById(R.id.prima1);
        m1.setText("Bună "+numele+"! Mă bucur să te văd și la a doua lecție!");
        TextView buton=(TextView) findViewById(R.id.sin2);
        buton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(sintaxa1.this,sintaxa2.class);
