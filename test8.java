...
public class test8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView buton=(TextView) findViewById(R.id.test8);
        buton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                EditText a1 = (EditText) findViewById(R.id.raspunsT8);

                if (a1.getText().toString().equals("0")) {
                    Intent intent = new Intent(test8.this, conditii15.class);
